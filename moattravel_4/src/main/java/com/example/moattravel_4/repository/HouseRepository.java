...
public interface HouseRepository extends JpaRepository<House, Integer> {
	...
	public Page<House> findByAddressLike(String aria, Pageable pageable);
	...
	public Page<House> findByOrderByCreatedAtDesc(Pageable pageable);

	public Page<House> findByOrderByPriceAsc(Pageable pageable);
